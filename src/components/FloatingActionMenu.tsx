...
const FloatingActionMenu = () => {
  ...
  const buttonStyles = cn(
    "fixed bottom-6 z-50 h-14 w-14 rounded-full shadow-2xl transition-all duration-500 flex items-center justify-center hover:scale-110 active:scale-95 border-2 border-accent hidden md:flex",
