      ...
      {items.map((item, i) => {
        ...
        return (
          <motion.button
            ...
            className={cn(
              "w-full group flex items-center justify-between px-4 py-3 md:py-3.5 rounded-xl border transition-all duration-300 shadow-sm",
              isVideo 
          ...
          >
            ...
            <div className="flex flex-col items-start text-start min-w-0 flex-1 pr-4 rtl:pr-0 rtl:pl-4">
              <span className={cn(
                "text-xs md:text-sm font-black leading-tight break-words",
              ...
              <div className="flex items-center gap-2 mt-0.5">
                ...
                {item.size && (
                  <>
                    ...
                    <span className="text-[9px] font-bold text-slate-400">{item.size}</span>
                  </>
                )}
              </div>
            </div>
