...
export const majorsData: MajorInfo[] = [
  ...
  },
  {
    ...
    nameAr: "هندسة القوى الكهربائية",
    description: "Focusing on power generation, transmission, and distribution systems.",
    descriptionAr: "التركيز على أنظمة توليد ونقل وتوزيع الطاقة الكهربائية.",
    longDescriptionAr: "تعد هندسة القوى الكهربائية من الأعمدة الأساسية للحضارة الحديثة. يدرس الطالب في هذا التخصص كيفية توليد الطاقة من المصادر المختلفة (التقليدية والمتجددة)، وطرق نقلها وتوزيعها بكفاءة وأمان. يشمل البرنامج دراسة الآلات الكهربائية، إلكترونيات القوى، أنظمة الحماية، والشبكات الذكية. يعمل الخريجون في محطات التوليد، شركات توزيع الكهرباء، والمشاريع الإنشائية الكبرى.",
    ...
    hourPriceParallel: 60,
    expectedSalaryAr: "500 – 1,200 دينار (الأردن) | 2,500 – 7,500 دولار (الخليج)",
    careerFieldsAr: ["مهندس محطات توليد", "مهندس نقل وتوزيع", "مهندس تمديدات كهربائية", "مصمم أنظمة إنارة", "شركات الطاقة المتجددة"],
  },
  {
    id: "industrial",
    name: "Industrial Engineering",
    nameAr: "الهندسة الصناعية",
    description: "Optimising complex processes, systems, and organisations.",
    descriptionAr: "تحسين العمليات والأنظمة والمنظمات المعقدة لزيادة الكفاءة.",
    longDescriptionAr: "الهندسة الصناعية هي تخصص يجمع بين الهندسة والإدارة لتحسين الكفاءة والإنتاجية. يدرس الطالب كيفية تصميم وتحليل وتطوير العمليات الصناعية والخدمية، مع التركيز على بحوث العمليات، إدارة الجودة، سلاسل التوريد، والجدوى الاقتصادية. يُعد خريج الهندسة الصناعية 'مهندس الإدارة' القادر على اتخاذ القرارات المبنية على البيانات في المصانع والشركات الكبرى.",
    ...
    careerFieldsAr: ["مهندس تخطيط وإنتاج", "أخصائي إدارة جودة", "مهندس سلاسل توريد", "محلل بيانات صناعية", "استشاري تطوير أعمال"],
  },
  {
    id: "architecture",
