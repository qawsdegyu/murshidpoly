  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-0 sm:p-4">
      ...
      <motion.div
        ...
        className="relative w-full max-w-4xl h-full sm:h-auto sm:max-h-[90vh] bg-white dark:bg-neutral-950 sm:rounded-[3rem] shadow-2xl overflow-hidden flex flex-col"
      >
        {/* Modal Header/Image */}
