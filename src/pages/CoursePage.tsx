  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 px-4 md:px-8 pt-8 max-w-7xl mx-auto">
        ...
        <div className="bg-white/80 border border-slate-200 shadow-sm backdrop-blur-xl dark:bg-white/[0.03] dark:border-white/[0.08] dark:backdrop-blur-2xl rounded-[3rem] p-8 md:p-14 mb-12 relative overflow-hidden group">
        ...
        <section 
          className="mt-32 relative overflow-hidden rounded-[3.5rem] p-1 bg-white/80 border border-slate-200 shadow-sm backdrop-blur-xl dark:bg-white/[0.03] dark:border-white/[0.08] transition-all duration-500 animate-in fade-in duration-1000"
        >
          ...
          <div className="relative z-10 p-10 md:p-14 flex flex-col lg:flex-row items-center justify-between gap-10">
            ...
            <a
              ...
              className="flex items-center gap-4 px-12 py-6 rounded-[2.5rem] bg-emerald-500 text-white font-black text-xl hover:bg-emerald-400 transition-all shadow-xl whitespace-nowrap active:scale-95"
            >
