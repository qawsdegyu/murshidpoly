    ...
    >
      ...
      >
        <m.div variants={fadeUp} className="mb-10">
          <button
            onClick={() => navigate(-1)}
            className="group inline-flex items-center gap-2 px-6 py-2.5 rounded-2xl bg-white/80 border border-slate-200 shadow-sm backdrop-blur-xl dark:bg-white/[0.03] dark:border-white/[0.08] dark:backdrop-blur-2xl hover:border-slate-300 transition-all"
          >
            <ArrowLeft className={cn("w-4 h-4 text-slate-400 group-hover:text-blue-500", dir === "rtl" ? "rotate-180" : "")} />
        ...
        <m.div variants={fadeUp} className="bg-white/80 border border-slate-200 shadow-sm backdrop-blur-xl dark:bg-white/[0.03] dark:border-white/[0.08] dark:backdrop-blur-2xl rounded-[3rem] p-8 md:p-14 mb-12 relative overflow-hidden group">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-6">
            ...
            <span className="text-[10px] md:text-[12px] font-black uppercase text-slate-400 tracking-wider">
        ...
        <div className="z-40 mb-12 flex justify-center w-full px-2">
          <div className="p-2.5 rounded-[2rem] bg-white/80 dark:bg-slate-900/60 border border-white/40 dark:border-white/10 backdrop-blur-3xl shadow-2xl flex flex-wrap justify-center items-center gap-2.5 max-w-full">
            {tabs.map((tab) => {
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isActive 
                      ...
                      : "text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10"
                  )}
                >
                  {isActive && (
                    <m.div
        ...
        <div className="min-h-[300px] relative mb-20">
          <AnimatePresence mode="wait">
            {!activeTab ? (
              ...
              >
                <div className="w-20 h-20 rounded-[2.5rem] bg-blue-500/10 flex items-center justify-center mb-6 animate-bounce-slow">
        ...
        <m.div variants={fadeUp} className="mt-20 mb-20 flex flex-col items-center gap-8">
          <button
            onClick={() => setShowInstructors(!showInstructors)}
            className="group flex items-center gap-4 px-8 py-4 rounded-[1.5rem] bg-white/50 dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 hover:border-amber-500/30 transition-all shadow-sm active:scale-95"
          >
        ...
        <m.section 
          variants={fadeUp} 
          className="mt-32 relative overflow-hidden rounded-[3.5rem] p-1 bg-white/80 border border-slate-200 shadow-sm backdrop-blur-xl dark:bg-white/[0.03] dark:border-white/[0.08] transition-all duration-500"
        >
          ...
          <div className="relative z-10 p-10 md:p-14 flex flex-col lg:flex-row items-center justify-between gap-10">
            <div className="flex items-center gap-8 flex-col md:flex-row text-center md:text-start">
              <div className="w-20 h-20 rounded-[2.5rem] bg-emerald-500/20 border border-emerald-500/30 flex items-center justify-center text-emerald-400 shrink-0">
            ...
            <m.a
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-4 px-12 py-6 rounded-[2.5rem] bg-emerald-500 text-white font-black text-xl hover:bg-emerald-400 transition-all shadow-xl whitespace-nowrap"
            >
