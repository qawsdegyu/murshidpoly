  ...
  return (
    <div className="pb-20">
      ...
      <motion.div
        ...
        className="mb-8 p-6 md:p-8 rounded-[2.5rem] bg-gradient-to-br from-emerald-500/10 via-emerald-500/5 to-transparent border border-emerald-500/20 backdrop-blur-xl relative overflow-hidden group"
      >
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-5">
            <motion.div 
              ...
              className="w-14 h-14 rounded-2xl bg-emerald-500/20 border border-emerald-500/30 flex items-center justify-center text-emerald-400 shrink-0"
            >
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="flex items-center gap-3 px-8 py-4 rounded-2xl bg-emerald-500 text-white font-black hover:bg-emerald-400 transition-all shadow-lg shadow-emerald-500/20"
          >
      ...
      <div className="relative mb-8">
        ...
        <Input 
          ...
          className="ltr:pl-12 rtl:pr-12 h-14 glass text-lg rounded-2xl border-white/10 shadow-elegant transition-all focus:ring-2 focus:ring-primary/20" 
        />
      </div>
      ...
      <div className="flex flex-wrap gap-2 mb-10 overflow-x-auto pb-2 scrollbar-hide">
        {categories.map((cat) => {
          ...
          return (
            ...
            >
              <Icon className={`h-4 w-4 ${isActive ? "text-white" : "text-primary dark:text-accent"}`} />
              <span className="font-bold text-sm">{lang === "ar" ? cat.nameAr : cat.nameEn}</span>
              {isActive && (
                <motion.div 
