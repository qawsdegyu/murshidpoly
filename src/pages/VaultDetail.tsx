...
export default function VaultDetail() {
  ...
  return (
    ...
    >
      ...
      {/* Course header */}
      <div className="bg-surface/80 border border-border shadow-sm backdrop-blur-xl dark:bg-surface/40 dark:border-white/10 dark:backdrop-blur-2xl rounded-[3rem] p-8 md:p-14 mb-12 relative overflow-hidden group">
            ...
            <button
              ...
              className={cn(
                ...
                isActive 
                  ...
                  : "text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white bg-surface/50 dark:bg-surface/10 border border-transparent hover:border-border"
              )}
            >
              {isActive && (
                <motion.div
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-16 flex flex-col items-center gap-8">
        <button
          ...
          className="group flex items-center gap-4 px-8 py-4 rounded-[1.5rem] bg-surface/50 dark:bg-white/[0.03] border border-border dark:border-white/10 hover:border-amber-500/30 transition-all shadow-sm active:scale-95"
        >
        ...
        <AnimatePresence>
          {showInstructors && (
            ...
            >
              <div className="py-10 border-t border-border dark:border-white/5">
      ...
      <motion.section 
        ...
        viewport={{ once: true }}
        className="mt-16 p-8 rounded-[2.5rem] bg-surface/80 border border-border shadow-sm backdrop-blur-xl dark:bg-surface/40 dark:border-white/10 dark:backdrop-blur-2xl relative overflow-hidden group transition-all duration-500 hidden md:block"
      >
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <motion.a
            ...
            target="_blank"
            className="px-10 py-5 rounded-2xl bg-emerald-500 text-white font-black hover:bg-emerald-400 shadow-xl"
          >
